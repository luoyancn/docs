...
\section{Makefile}
Makefile当中包含了一些特殊的系统变量，这些特定的系统变量如表\nameref{tab:macro_of_makefile}所示
\begin{center}
...
Makefile本身也支持嵌套。假设现在有一个工程，其目录结构如图\nameref{fig:submake}所示。
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{make.png}
  \caption{Makefile嵌套}
  \label{fig:submake}
\end{figure}
