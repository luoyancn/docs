...
Rust目前的版本当中，异步/同步的支持比较完善，目前，\href{https://github.com/rust-lang/futures-rs}{Futures}
提供了完整实现，\href{https://github.com/tokio-rs/tokio}{Tokio}也提供了
...
// 带有生命周期的异步函数
fn async_with_lifetime<'a>(x: &'a u8) -> impl Future<Output = u8> + 'a {
    async move{*x}
}
