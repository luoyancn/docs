...
\newsavebox\yuibox
\savebox\yuibox{\tikz[opacity=0.5]\node{\includegraphics[scale=0.012]{takamura_yui.png}};}
...
% xwatermark实现水印的方式
\newwatermark*[oddpages,scale=8,xpos=60,ypos=-72]{\usebox\bbbox}
\newwatermark*[oddpages,scale=7,xpos=-60,ypos=-78]{\usebox\yuibox}
