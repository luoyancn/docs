...
\documentclass[newfloat,tikz,usenames,dvipsnames,svgnames,table,b5paper]{book}
\usepackage{xcolor}
\usepackage{ifthen}
\usepackage{graphicx}
\usepackage{minted}
...
{beamer, colback=gray!20!white,colframe=gray!35!white,listing only,breakable,width=\linewidth,listing engine=minted,
 minted language={#1},minted options={fontsize=\scriptsize,linenos=false,breaklines=true,breakanywhere,breaksymbolleft=,breakanywheresymbolpre=,}}
