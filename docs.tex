...
%\setmainfont{Monofur Nerd Font Mono}
%宋体
...
\geometry{top=2.4cm,bottom=2.4cm}
% 修改图注为 图1-1 xxx
% 修改表注为 表1-1 xxx
...
\newenvironment{code-in-enumerate}[1]
 {\VerbatimEnvironment
  ...
  \begin{mdframed}[topline=false, bottomline=false, leftline=false,
                   ...
                   userdefinedwidth=\textwidth]
  \begin{minted}[fontsize=\scriptsize,linenos=false,breaklines=true,breakanywhere,breaksymbolleft=,breakanywheresymbolpre=,]{#1}}
  %\begin{minted}[fontfamily="Monofur Nerd Font Mono", fontsize=\scriptsize,linenos=false,breaklines=true,breakanywhere,breaksymbolleft=,breakanywheresymbolpre=,]{#1}}
