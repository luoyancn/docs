...
\newsavebox\nerobox
\savebox\nerobox{\tikz[opacity=0.5]\node{\includegraphics[scale=0.05]{nero.png}};}

\newsavebox\scathachbox
\savebox\scathachbox{\tikz[opacity=0.5]\node{\includegraphics[scale=0.0116]{scathach.png}};}

\newsavebox\yuibox
\savebox\yuibox{\tikz[opacity=0.5]\node{\includegraphics[scale=0.0146]{yui.png}};}
...
\newwatermark*[evenpages,scale=7,xpos=-49,ypos=-80]{\usebox\nerobox}
\newwatermark*[evenpages,scale=7,xpos=64,ypos=-80]{\usebox\scathachbox}
